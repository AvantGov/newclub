    ...
    return(
        <div className='Home'>
            <div className="Home__container" id="cont_intro">
                ...
                <p className='container__copy'>Welcome to the interactive History Kit visualizer! This page can be used to generate visuals that accompany History Kit songs (or any music really, i don't care how you use this thing).</p>
            ...
            <div className="Home__container" id='cont_about'>
                ...
                <hr className="container__rule"/>
                <p className='container__copy'>This website was developed by AC (avantgov.github.com) using the React.js framework. The visual engine is an implemented instance of Hydra (hydra.ojack.xyz), a live code-able video synth and coding environment.</p>
            ...
            <div className="Home__container" id='cont_music'>
                ...
                <hr className="container__rule"/>
                <p className='container__copy'>"History Kit" is the stage name for electronic music created by AC, dubbed simply "bright sound".</p>
                <p className='container__copy'>Under the hood, it's a lot of Elektron devices and Juno-6 worship. (iykyk)</p>
                <p className='container__copy'>The song that pairs with this visual is "Bottle Talk". This track can be found on music streaming services with the links below.</p>
                <p className='container__copy'>History Kit is mostly on <a className='link' href="https://www.twitter.com/MalwareForFree" target="_blank" rel='noopenner noreferrer'>twitter</a>.</p>
            </div>
            ...
            <div className="Home__container" id="cont_web3">
                ...
                <hr className="container__rule"/>
                <p className='container__copy'>Web3 is an irresponsible and illinformed product of solutionism that has no place in the conversation of ethical web development.</p>
                <p className='container__copy'>History Kit visualisers are free to every user and are built with open-source projects.</p>
